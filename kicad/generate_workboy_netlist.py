...
# Resistors
# ===========================================================================
# UNI-ROYAL 0402WGF*TCE, 0402 1% 62.5mW 50V. These are **JLCPCB Basic parts** and
# JLCPCB stocks them, so PCBA pays no per-unique-extended-part fee.
#
# They are, however, OUT OF STOCK at LCSC retail. That does not matter when JLCPCB
# does the SMT (they source from their own library), but it does if you hand-build.
# For hand-assembly buy the YAGEO RC0402FR-07 equivalents instead - identical spec
# (0402 1% 62.5mW 50V), deep LCSC stock, but Extended at JLCPCB:
#     10k  C60490   220R C112291   1k C106235   5.1k C105872
# All eight part numbers verified against both catalogues 2026-07-28.
